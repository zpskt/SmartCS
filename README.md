...
```
```shell
pip install langchain langgraph-checkpoint-postgres postgres langgraph python-multipart fastapi docx pdfplumber langchain_chroma langchain_community langchain_core langchain_text_splitters dashscope streamlit -i https://mirrors.aliyun.com/pypi/simple/
