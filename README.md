...
```
```shell
pip install django django-cors-headers==4.3.1 langchain langgraph-checkpoint-postgres postgres langgraph python-multipart fastapi docx pdfplumber langchain_chroma langchain_community langchain_core langchain_text_splitters dashscope streamlit -i https://mirrors.aliyun.com/pypi/simple/
